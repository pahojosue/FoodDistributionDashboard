...
<?php 
  ...
  $managerProfiles = $managerProfile->get();
...
<div class="row">
    <div class="col-sm-6">
     <h3 class="mb-4">Manager Profile List</h3>
    </div>
    <div class="col-sm-6 text-end">
        <a href="dashboard.php?page=manager-profile-form" class="btn btn-success">Add New</a>
    </div>
</div>
...
<table class="table table-hover">
    ...
    <tbody>
        <?php
        if(!empty($managerProfiles)) {
           
        $sn = 1;
       foreach($managerProfiles as $data){
        ?>
      <tr>
      <td><?= $sn; ?></td>
